...
left_arm_chain = kin.create_chain(
    ["yumi_joint_1_r", "yumi_joint_2_r", "yumi_joint_7_r", 
     ...
     "yumi_joint_6_r"],
    "yumi_base_link", "gripper_r_base")  # Assuming 'yumi_tool0_l' is the end effector name for the left arm

with open("lift_and_mop_table_both.json") as f:
...
filtered_left_arm_positions = [reorder(filtered_position[1::2]) for filtered_position in filtered_positions]
