...
from base_servoer import PIDController, SiftLightGlueVisualServoer, Dust3RisualServoer
...
class RelCamVSDust3R(Dust3RisualServoer):
    def __init__(self, DIR):
        super().__init__(
            rgb_ref=np.array(Image.open(f"{DIR}/demo_wrist_rgb.png")),
            use_depth=False
    ...
    def run(self):
        ...
        while num_iteration < 126:
            ...
            # Compute transformation
            T_delta_cam = self.estimate_rel_pose()
